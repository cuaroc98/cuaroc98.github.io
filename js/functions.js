...
function resize(img_id)
{
	...
	else if(img_id = 'bike-pic' && bike == 0) {initMap(51.50694616, 7.46843398, 13, 'bike-map'); bike = 1;}
	else if(img_id = 'bike-pic' && run == 0) {initMap(51.49331465, 7.45424509, 14, 'run-map'); run = 1;}
}
